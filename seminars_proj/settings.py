"""
Django settings for seminars_proj project.
...
ROOT_URLCONF = 'seminars_proj.urls'
...
WSGI_APPLICATION = 'seminars_proj.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file_2': {
            'class': 'logging.FileHandler',
            'filename': './log/django_2.log', # 'filename': '.log/django.log'
            'formatter': 'verbose',
        },
        'file_3': {
            'class': 'logging.FileHandler',
    ...
    'loggers': {
        ...
        'my_app_2': {
            'handlers': ['console', 'file_2'], # 'handlers': ['console', 'file'],
            'level': 'DEBUG',
            'propagate': True,
        },
        'my_HW_01': {
